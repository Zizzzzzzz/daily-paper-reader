...
tags: ["query:evlm"]
score: 8.0
evidence: 基于落地感知的高效在线VLA适应
tldr: 预训练的视觉-语言-动作（VLA）模型为机器人操作提供强先验，但在线适应细粒度任务时，任务奖励难以提供区域级引导，且VLA推理和回放更新计算代价高。本文提出GRAFT，通过区域级监督学习与任务相关的视觉落地，实现高效的在线VLA适应。实验表明该方法能在有限真实机器人交互下快速适应新任务，兼顾推理效率与操作精度。
source: arxiv
